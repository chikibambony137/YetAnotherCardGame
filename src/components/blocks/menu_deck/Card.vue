<template>
  <div
    ...
    <div class="card__buttons" v-show="isChoosed">
      ...
      <button class="card__bttn card__bttn_info" v-if="displayedValues.info">
        INFO
      </button>
      <button
...
const { card, displayedValues } = defineProps({
  card: Object,
  displayedValues: Object,
});
...
.card_choosed {
  ...
  box-shadow: 0 0 0 3px var.$button-color_choosed,
    /* Внутренняя обводка */ 0 10px 25px rgba(0, 0, 0, 0.2); /* Тень для эффекта поднятия */
